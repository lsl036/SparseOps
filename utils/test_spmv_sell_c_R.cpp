...
double test_sell_c_R_matrix_kernels(const CSR_Matrix<IndexType,ValueType> &csr_ref, int kernel_tag, int schedule_mod)
{
    ...
    if ( 0 == sell_c_R.kernel_flag){
        ...
        test_spmv_kernel(csr_ref, SpOps_csr<IndexType, ValueType>,
                         sell_c_R, SpOps_sell_c_R<IndexType, ValueType>,
                         "sell_c_R_serial_simple");

        std::cout << "\n===  Performance of SELL-c-R serial simple  ===" << std::endl;
        // count performance of Gflops and Gbytes
        msec_per_iteration = benchmark_spmv_on_host(sell_c_R, SpOps_sell_c_R<IndexType, ValueType>,"sell_c_R_serial_simple");
    ...
    else if ( 1 == sell_c_R.kernel_flag)
    {
        ...
        // count performance of Gflops and Gbytes
        msec_per_iteration = benchmark_spmv_on_host(sell_c_R, SpOps_sell_c_R<IndexType, ValueType>,"sell_c_R_omp_simple");
    ...
    else if ( 2 == sell_c_R.kernel_flag)
    {
        ...
        // count performance of Gflops and Gbytes
        msec_per_iteration = benchmark_spmv_on_host(sell_c_R, SpOps_sell_c_R<IndexType, ValueType>,"sell_c_R_omp_ld");
    }
